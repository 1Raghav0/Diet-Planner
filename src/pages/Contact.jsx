  ...
  return (
    <div className="w-full py-24 px-6 transition-colors duration-300 bg-gray-100 text-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        "Have questions about your diet? Need a personalized nutrition plan or help reaching your health goals? Let’s connect!"
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-10">
          ...
          <div className="shadow-lg rounded-lg p-8 bg-white border border-gray-300">
            ...
            <p className="text-gray-700">We love talking nutrition, wellness, fitness goals, and how AI can simplify healthy living.</p>
